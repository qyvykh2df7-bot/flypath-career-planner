...
export function SessionStatusBadge({ session, today, className = "" }: SessionStatusBadgeProps) {
  ...
  return (
    <span
      className={`inline-flex max-w-full min-w-0 shrink rounded-md px-1 py-0.5 text-[8px] font-medium tracking-normal ${displayStatusBadgeClass(displayStatus)} ${className}`}
    >

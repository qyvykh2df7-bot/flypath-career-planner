...
const panelBtnDestructive =
  "inline-flex items-center gap-1.5 rounded-lg px-2 py-1 text-[12px] font-medium text-red-700/85 transition-[background-color,color] duration-300 ease-out hover:bg-red-50/80 hover:text-red-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-200/60";
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <span
                  ...
                  aria-hidden
                />
                <p className="text-[13px] font-medium text-slate-500">Semana activa</p>
              </div>
              <div className="mt-0.5 flex flex-wrap items-center gap-x-2 gap-y-0.5">
                ...
                <p className="flex items-center gap-1 text-[13px] text-slate-500 sm:inline-flex">

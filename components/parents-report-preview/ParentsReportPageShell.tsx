...
type ParentsReportPageShellProps = {
  sectionLabel: string;
  children: ReactNode;
};

/** Contenedor editorial de página (preview padres). */
export function ParentsReportPageShell({ sectionLabel, children }: ParentsReportPageShellProps) {
  return (

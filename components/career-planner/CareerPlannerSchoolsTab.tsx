...
export function CareerPlannerSchoolsTab({
  ...
  const estadoVerificacionOptions = [
  ...
  const handleToggleCatalogEntry = (entry: SchoolEntry) => {
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            ...
            {pickerOpen ? (
              <div
                ...
                className="absolute left-0 top-[calc(100%+6px)] z-[60] w-[min(100%,22rem)] rounded-xl border border-[#c9a454]/30 bg-white p-3.5 shadow-[0_16px_40px_-12px_rgba(15,26,51,0.35)] ring-1 ring-[#0f1a33]/8"
              >
            ...
            <div className="border-t border-slate-200/80 px-4 pb-4 pt-3">
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                <SelectField
                  ...
                  options={programaAdvancedOptions}
                  onChange={(v) => setNewSchool((s) => ({ ...s, programa: v as School["programa"] }))}
                />
                <SelectField
                  label="Estado de verificación"
                  value={newSchool.estadoVerificacion}
                  options={estadoVerificacionOptions}
                  onChange={(v) =>

...
export const metadata = {
  title: "Pago cancelado | FlyPath",
  robots: { index: false, follow: false },
};

export default function CareerPlannerCheckoutCancelPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#0f1a33] px-6 py-12 text-white">
      <section className="w-full max-w-lg rounded-xl border border-white/10 bg-[#16223f] p-7 shadow-[0_16px_48px_rgba(0,0,0,0.28)] sm:p-9">
        ...
        <h1 className="mt-3 text-2xl font-semibold">No se realizó el pago</h1>
        <p className="mt-3 text-sm leading-6 text-slate-300">
          Puedes volver al Career Planner cuando quieras. No se ha concedido ningún acceso ni se ha descargado ningún informe.
        </p>

...
/**
 * Estándar definitivo de ficha individual FlyPath:
 * header + cards de costes + bloques escaneables (incluidos, operación y ruta,
 * riesgos, pendientes/preguntas, opiniones y lectura/análisis), sin "No claro".
 */
            ...
            <ul className="mt-2 space-y-1 text-[15px] text-slate-700">
              {(isAdventia
                ? [
                    ...
                    "Coste final incluyendo tasas, licencia y administración.",
                    "Condiciones completas de financiación mensual con Sabadell Consumer.",
                    "Qué ocurre si no se alcanza el mínimo de alumnos.",
                    "Confirmar contrato completo antes de pre-reserva o apertura de expediente.",
                  ]
                : isEuropeanFlyers
                  ? [
                ...
                : [...school.pendingData, ...school.keyQuestions]

...
export interface MissionMeta {
  id: string;
  title: string;
  /** Higher number = later/harder. Planning estimate only. */
  order: number;
  prerequisites: string;
  skills: string;
  /** "playable" now (foundation placeholder) or "implemented-last" capstone. */
  alphaStatus: "essential" | "implemented-last";
  summary: string;
  isFoundationPlaceholder: true;
}

export const STUDENT_PILOT_MISSIONS: Record<string, MissionMeta> = {
  "sp-missions.circuit-training.mission": {
    id: "sp-missions.circuit-training.mission",
    title: "Circuit Training",
    order: 1,
    prerequisites: "Takeoff & Initial Departure, Circuit Operations",
    skills: "Circuit legs, downwind/final position calls, sequencing, touch-and-go intention",
    alphaStatus: "essential",
    summary: "Multi-section guided local circuit.",
    isFoundationPlaceholder: true,
  },
  "sp-missions.touch-and-go-session.mission": {
    id: "sp-missions.touch-and-go-session.mission",
    title: "Touch & Go Session",
    order: 2,
    prerequisites: "Circuit Training",
    skills: "Repeated circuits, touch-and-go vs full-stop choices",
    alphaStatus: "essential",
    summary: "Several guided circuits with touch-and-go / full-stop choices.",
    isFoundationPlaceholder: true,
  },
  "sp-missions.local-training-flight.mission": {
    id: "sp-missions.local-training-flight.mission",
    title: "Local Training Flight",
    order: 3,
    prerequisites: "Modules 1–8",
    skills: "Full arc: startup, taxi, departure, circuit/arrival, landing, parking",
    alphaStatus: "essential",
    summary: "Startup through parking — the natural Alpha capstone.",
    isFoundationPlaceholder: true,
  },
  "sp-missions.first-solo.mission": {
    id: "sp-missions.first-solo.mission",
    title: "First Solo",
    order: 4,
    prerequisites: "Local Training Flight",
    skills: "Capstone, reduced guidance, scripted guided local flight",
    alphaStatus: "implemented-last",
    summary: "Playable future Student Pilot capstone — implemented last.",
    isFoundationPlaceholder: true,
  },
};

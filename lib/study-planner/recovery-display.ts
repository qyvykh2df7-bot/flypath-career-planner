...
function shortenStepTitle(title: string): string {
  const rules: [RegExp, string][] = [
    ...
    [/^Haz un simulacro/i, "Simulacro diagnóstico + errores"],
    [/^Planifica 3 sesiones/i, "3 sesiones realistas"],
    [/^Limpia primero los repasos/i, "Repasos atrasados primero"],
    [/^Revisa errores pendientes/i, "Revisa errores pendientes"],
...
/** Resumen del plan en una o dos frases cortas para la UI. */

...
- Validación local: 581 pruebas correctas, TypeScript y `git diff --check` correctos; lint focalizado sin errores nuevos. Pendiente no bloqueante: normalizar assets PDF incompatibles (`.webp` y JPG con contenido PNG) para eliminar avisos de `@react-pdf/renderer`.
